                    ...
                    for(z = 0; z < current_entry_max; z++) {
                        ...
                        if(current_post_storage[z] != null) {
                            if(jseo_portfolio_content.classList.contains("grid")) {
                                ...
                                jseo_portfolio_content.innerHTML += '<div class="jseo_column"><a href="' + current_post_storage[z]['the_permalink']  + '" class="vplain_image"><img src="' + current_post_storage[z]['the_featured_image'] + '">' + telemetry + '</a> <div class="vplain_information"><p class="jseo_portfolio_title">' + current_post_storage[z]['the_title'] + '</p><p class="jseo_portfolio_description">' + current_post_storage[z]['the_excerpt'].substring(0, 100) + '</p></div></div>';
                            }
                        } 
                    }
